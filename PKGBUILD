...
_chrome_ver=153.0.8010.36
_commit=5ee23842c57cf6fa293809960bb3e25c44ae7cad
pkgrel=1
_launcher_ver=8
_manual_clone=1
_system_clang=1
...
source=(https://commondatastorage.googleapis.com/chromium-browser-official/chromium-$pkgver-lite.tar.xz
        ...
        chromium-153-revert-crubit-changes.patch
...
sha256sums=('SKIP'
            ...
            '2eef1e45894ffdc36b200df76d2acc67bb1f0957d3fcd6150c70b2ecaf248f47'
            ...
            '24205e23abcd25c57cfec6c80ef328ee368982068e0d30d2e4363c708d732131'
            ...
            'a0fa92bd2d1322e5d3f2ac836d69c9bf565759b72b721ed0c2e9d8134ba73308'
            ...
            '638e6e3143abbbe8b141130d5e51a6d825b049c89c32fe4c568adb9a31078999'
...
prepare() {
  ...
  patch -Np1 -i $srcdir/chromium-152-unbundle-minizip-undo-unicode.patch

  #patch -Np1 -i $srcdir/chromium-152-unbundle-opus-devtools.patch

  patch -Np1 -i $srcdir/chromium-153-revert-crubit-changes.patch
